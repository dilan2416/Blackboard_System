...
<%
    ...
    if(!request.getParameter("pagecommand").equals("")){
        ...
        if (command[0].equals("browse") && command[2].equals("course")){
        tableName = command[1];
        }
        else if(command[1].equals("add")){
            Student courseEditor = new Student("CourseEditor", 0000, "Female", "NULL", "USA");
            courseEditor.addCourse(command[0], command[2]);
            tableName = command[0];
        }
        else if(command[1].equals("drop")){
            Student courseEditor = new Student("CourseEditor", 0000, "Female", "NULL", "USA");
            courseEditor.deleteCourse(command[0], command[2]);
            tableName = command[0];
        }
    }
...
<h3>The courses you have signed up</h3>
<%
